...
public class TicketPriceTest {
    ...
    @Test
    public void shouldGetTicketPriceUnderPriceWithWorkshops() {
        List<TicketPrice> tickets = repository.getTicketPriceUnderPriceWithWorkshops(new BigDecimal("1000"));
        assertTrue(tickets.size() > 0);
    }

    @Test
    public void shouldFindTicketsByPricingCategoryName() {
        List<TicketPrice> tickets = repository.namedFindTicketsByPricingCategoryName("Regular");
        assertTrue(tickets.size() > 0);
    }

    @Test
    public void shouldFindTicketsByPricingCategoryNameAsNativeQuery() {
